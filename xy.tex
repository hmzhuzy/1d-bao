...
\eea
where $W_r^2$ describes the dampling of the linear power spectrum. The raw 
...
scale $\Sigma$ by 60 per cent, i.e., a factor of three. 
The damping factor is above 0.8 for $k\lesssim0.1\ \mr{Mpc}^{-1}$. 
...
\section{ Discussions}
\label{dis}
In reality, the Universe is 3D instead of 1D.
